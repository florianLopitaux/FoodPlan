...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleNotFound(AbstractNotFoundException ex, HttpServletRequest request) {
        return GlobalExceptionHandler.buildError(HttpStatus.NOT_FOUND, request.getRequestURI(), ex);
    }
    ...
    public static ResponseEntity<ApiError> buildError(HttpStatus status, String uri, Exception exception) {
        return GlobalExceptionHandler.buildError(status, uri, exception.getClass().getSimpleName(), exception.getMessage());
    }
